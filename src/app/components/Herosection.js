        ...
        <div className={styles.container}>
          <div className={styles.grid_two_section}>
            <div className={heroStyles.hero_content}>
              <h1>{title}</h1>
              <p>
                Whether you're looking for critically acclaimed dramas or
                thrilling action movies, we have what you need. Explore our
                collection of the most recent and popular movies, and discover
